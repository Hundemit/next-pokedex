...
import { ChartRadarDots } from "../poke-chart";
import { PokemonDetailsLoading } from "./poke-details-loading";
import { PokemonDetails } from "./poke-details";
...
export default function PokemonDetailPage({ params }: { params: Promise<{ name: string }> }) {
  ...
  return (
    <div className="min-h-[70vh] h-full">
      <div className="flex flex-col gap-10 md:mt-12 mx-auto md:px-4 max-w-7xl ">
        {/* Back button */}
        {(isLoading || pokemon) && (
          <Link
            href={"/pokedex/"}

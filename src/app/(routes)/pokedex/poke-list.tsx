...
import { PokeCard, LoadingPokeCard } from "./poke-card";
...
const Pokelist = ({ className }: { className?: string }) => {
  const PAGE_SIZE = 16;
  ...
  const { data, isLoading, mutate } = usePokemonList<PokemonApiResponse>(type);

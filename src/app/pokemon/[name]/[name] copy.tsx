...
//               <img className="w-36 h-36 object-fill" src={pokemon.sprites.other["official-artwork"].front_default} />
//             </div>
//             <div className="py-12 flex flex-col">
//               <h1 className="text-xl font-bold tracking-tight lg:text-2xl">{pokemon.name}</h1>
...
//                     <Card key={stat.stat.name} className="w-full rounded-md col-span-2">
//                       <CardHeader className="p-2">
//                         <div className="flex items-center justify-between">
//                           <span className="text-sm text-muted-foreground">{stat.stat.name}</span>
